...
import com.udacity.project4.utils.EspressoIdleResource
...
class RemindersActivityTest :
    ...
    fun createNewReminder() {
        ...
        //using thread sleep to observe changes
    ...
    fun showErrorToastMsg() {
        ...
        //clicking save with empty title should show a snackbar with enter title msg
        onView(withId(R.id.saveReminder)).perform(click())
